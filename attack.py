...
class PixelAttacker:
    ...
    def attack(self, img, model, target=None, pixel_count=1, verbose=False, plot=False):
        targeted_attack = target is not None
        target_class = target if targeted_attack else self.y_test[img,0]
        
        dim_x, dim_y = self.dimensions

        bounds = [(0, dim_x), (0, dim_y), (0, 256), (0, 256), (0, 256)]
        ...
        attack_result = attacker_algorithm.attacker(predict_fn, pixel_count, bounds, callback_fn)
